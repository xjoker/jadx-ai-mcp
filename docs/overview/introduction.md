...
| 💼 **Full JVM Support** | APK, JAR, AAR, DEX all supported. 39 MCP tools total, including 5 JAR-specific tools. |
...
- [Tools Reference](../reference/tools.md) - Complete 39-tool matrix
