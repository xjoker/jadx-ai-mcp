...
如果启动 MCP Server 时没有使用 `--jadx-instances` 参数，可以在对话中动态告诉 AI 连接：

**单个实例：**
```
请连接到 JADX 服务器 192.168.1.100:8650

或者更具体地：
添加 JADX 实例，地址 192.168.1.100，端口 8650，命名为 "my-app"
```
